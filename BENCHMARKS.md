...
Benchmark 1: ./target/release/pff clang /run/media/pt/gen4_test/llvm-project-llvmorg-20.1.0
  Time (mean ± σ):       8.9 ms ±   0.3 ms    [User: 33.0 ms, System: 65.1 ms]
...
Benchmark 1: ./target/release/pff s /run/media/pt/gen4_test/llvm-project-llvmorg-20.1.0
  Time (mean ± σ):      10.4 ms ±   0.3 ms    [User: 47.7 ms, System: 68.4 ms]
  Range (min … max):     9.6 ms …  11.8 ms    1000 runs
```
...
Benchmark 1: ./target/release/pff clang /home/pt/pff_test/llvm-project-llvmorg-20.1.0
  Time (mean ± σ):      31.8 ms ±   1.2 ms    [User: 84.1 ms, System: 94.9 ms]
  Range (min … max):    29.6 ms …  42.6 ms    1000 runs
...
Benchmark 1: ./target/release/pff s /home/pt/pff_test/llvm-project-llvmorg-20.1.0
  Time (mean ± σ):      37.6 ms ±   1.5 ms    [User: 113.2 ms, System: 98.7 ms]
  Range (min … max):    35.0 ms …  51.3 ms    1000 runs
```
