...
NOTE: These benchmarks are manually updated to reflect the state of the latest, performance altering, commit. As such, these results may not match the performance of the latest release.
